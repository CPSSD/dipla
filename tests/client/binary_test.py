...
class BinaryRunnerTest(unittest.TestCase):
    ...
    EXAMPLE_BINARY_PATH = PROJECT_DIRECTORY + "tests/example_binary/builds/ARM"
...
#        self.and_we_wait_for_a_few_seconds()
#        self.then_the_binary_will_not_be_running()
    ...
    def and_we_wait_for_a_few_seconds(self):
        time.sleep(3)
    ...
    def then_the_binary_will_not_be_running(self):
        self.assertFalse(self.binary_runner.is_running())

    def then_the_binary_will_be_running(self):
        self.assertTrue(self.binary_runner.is_running())
